    ...
    <body class="antialiased">
        <div class="container">
            <div class="row">
                <form method="POST">
                    @csrf
                    <h4>Dochody i koszty</h4>
                    <div class="row">
                        <div class="form-group col-xs-6 p-2 r-5">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-6 p-2 r-5">
                            <div class="grid-cols-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="zus" id="noZus" value="0" disabled>
                                    <label class="form-check-label" for="noZus">
                                        Ulga na start
                                    </label>
                                </div>
                            </div>
                            <div class="grid-cols-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="zus" id="smallZus" value="1"
                                    {{ request('zus') != 2 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="smallZus">
                                        Mały ZUS
                                    </label>
                                </div>
                            </div>
                            <div class="grid-cols-1">
                                <div class="form-check disabled">
                                    <input class="form-check-input" type="radio" name="zus" id="fullZus" value="2"
                                        {{ request('zus') == 2 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="fullZus">
                                        Pełny ZUS
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-xs-6 p-2">
                            <div class="grid-cols-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="health" id="no_health" value="0"
                                        {{ request('health') != 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="no_health">
                            ...
                            <div class="grid-cols-1">
                                <div class="form-check disabled">
                                    <input class="form-check-input" type="radio" name="health" id="with_health" value="1"
                                        {{ request('health') == 1 ? 'checked' : '' }}>
                                    <label class="form-check-label" for="with_health">
            ...
            <div class="row">
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col">Ryczałt</th>
                        <th scope="col">Zasady ogólne</th>
                        <th scope="col">Liniówka</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="color: {{ $ryczalt > $ogolne ? ($ryczalt > $liniowka ? 'green' : 'orange')
                                                : ($ryczalt < $liniowka ? 'red' : 'orange') }}">
                            {{ $ryczalt ?? 0 }}
                        </td>
                        <td style="color: {{ $ogolne > $ryczalt ? ($ogolne > $liniowka ? 'green' : 'orange')
                                                : ($ogolne < $liniowka ? 'red' : 'orange') }}">
                            {{ $ogolne ?? 0  }}
                        </td>
                        <td style="color: {{ $liniowka > $ogolne ? ($liniowka > $ryczalt ? 'green' : 'orange')
                                                 : ($liniowka < $ryczalt ? 'red' : 'orange') }}">
                            {{ $liniowka ?? 0  }}
                        </td>
                    </tr>
                    </tbody>
